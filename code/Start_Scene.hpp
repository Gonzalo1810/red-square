...
#ifndef START_SCENE_HEADER
#define START_SCENE_HEADER
...
namespace example
{
    ...
    class Start_Scene : public basics::Scene
    {
    ...
    private:
        ...
        std::shared_ptr < Texture_2D > logo_texture;        ///< Textura que contiene la imagen de fondo
        std::shared_ptr < Texture_2D > touch_texture;       ///< Textura que contene la imagen de "TOUCH"
    ...
    private:
        ...
        // Similar a otras escenas ( ej: intro_scene )
        void update_loading    ();
