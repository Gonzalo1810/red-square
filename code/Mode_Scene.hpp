...
namespace example
{
    ...
    class Mode_Scene : public basics::Scene
    {
        ...
        /**
         * Representa las opciones del menu
         */
        enum Option_Id
        {
            FACIL,
        ...
        struct Option
        {
            const Atlas::Slice * slice;  // Atlas Slice de texturas
            Point2f position;            // Posicion dentro del atlas
            float   is_pressed;          // presion de la opcion
        };
